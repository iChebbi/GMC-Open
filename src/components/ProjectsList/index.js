...
class ProjectsList extends React.Component {
  ...
  renderProjects = projects => projects.map((projectAttribute, key) => {
    const projectData = {
      id: projectAttribute.product.id,
      name: projectAttribute.product.name,
      description: projectAttribute.product.description,
      logo: projectAttribute.product.logo,
      keywords: projectAttribute.product.keywords,
      fullName: projectAttribute.owner.fullName,
      track: projectAttribute.track.name,
    }
    return <ProjectItem openModal={this.toggleModal} key={key} {...projectData} />
  })
